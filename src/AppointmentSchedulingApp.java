...
public class AppointmentSchedulingApp {
    public static void main(String[] args) {
        ...
        Doctor doctor1 = new Doctor(Role.DOCTOR, "Jack", "M", 45);
        Administrator admin = new Administrator(Role.ADMINISTRATOR, "Annie", "F", 32);
        // Pharmacist pharmacist = new Pharmacist(Role.PHARMACIST, "Pearl", "M", 28);
